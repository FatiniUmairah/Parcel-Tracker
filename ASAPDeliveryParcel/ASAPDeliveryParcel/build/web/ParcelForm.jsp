<%-- 
    Document   : ParcelForm
    Created on : Jan 13, 2024, 3:15:11 AM
    ...
    <div class="layout-container">
                <div class="table-wrapper">
                    <div class="table-title">
                        <div class="row">
                            <div class="col-sm-6">
                                <h2>Manage <b>Parcel</b></h2>
                            </div>
                            <div class="col-sm-6">
                                <a href="ParcelServlet?action=add" class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Add New Parcel</span></a>
                            </div>
                        </div>
                    </div>
                            ...
                            try {
                                ...
                                while (resultSet.next()) {
                                    out.println("<tr>");
                                        ...
                                        out.println("<td>");
                                            out.println("<a href=\"ParcelServlet?action=edit&id=" + resultSet.getString("TRACKING_NUMBER") + "\" class=\"edit\" data-toggle=\"modal\"><i class=\"material-icons\" data-toggle=\"tooltip\" title=\"Edit\">&#xE254;</i></a>");
                                            out.println("<a href=\"#\" onclick=\"confirmDelete('ParcelServlet?action=delete&id=" + resultSet.getString("TRACKING_NUMBER") + "')\" class=\"delete\"><i class=\"material-icons\" data-toggle=\"tooltip\" title=\"Delete\">&#xE872;</i></a>");
