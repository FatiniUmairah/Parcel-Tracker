<%-- 
    Document   : team
    Created on : Jan 12, 2024, 10:18:20 PM
  ...
  <section class="team_section layout_padding">
      ...
      <div class="heading_container heading_center">
        ...
        <div class="row">
          <div class="col-lg-3 col-sm-6">
            <div class="box ">
              <div class="img-box">
                <img src="images/fatini.jpg" class="img1" alt="">
              </div>
          ...
          <div class="col-lg-3 col-sm-6">
            <div class="box ">
              <div class="img-box">
                <img src="images/sofea.jpeg" class="img1" alt="">
              </div>
              <div class="detail-box">
                <h5>
                  SOFEA HANI
          ...
          <div class="col-lg-3 col-sm-6">
            <div class="box ">
              <div class="img-box">
                <img src="images/afrina.jpg" class="img1" alt="">
              </div>
              <div class="detail-box">
                <h5>
                  NUR AFRINA 
    ...
    <div class="row">
        <div class="col-lg-3 col-sm-6">
            <div class="box ">
              <div class="img-box">
                <img src="images/nazira.jpeg" class="img1" alt="">
              </div>
              <div class="detail-box">
                <h5>
                  NAZIRA KHAIRUNNISA
          ...
          <div class="col-lg-3 col-sm-6">
            <div class="box ">
              <div class="img-box">
                <img src="images/nadhirah.jpeg" class="img1" alt="">
              </div>
              <div class="detail-box">
                <h5>
                  NUR NADHIRAH
