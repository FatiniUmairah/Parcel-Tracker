                    ...
                    <div class="form-inputbox">
                        <%
                            ...
                            try {
                                ...
                                ResultSet resultSet = statement.executeQuery("SELECT COURIER_ID FROM APP.COURIER ORDER BY COURIER_ID DESC FETCH FIRST ROW ONLY");

                                if (resultSet.next()) {
                                    lastCourierId = resultSet.getString("COURIER_ID");
                                }
                            ...
                            String nextCourierId = "CR001";
                            if (lastCourierId != null && lastCourierId.matches("CR\\d+")) {
                                int lastCourierIdNumber = Integer.parseInt(lastCourierId.substring(2));
                                nextCourierId = "CR" + String.format("%03d", lastCourierIdNumber + 1);
                            }
                        %>
                        <input type="text" name="COURIER_ID" value="<%= nextCourierId %>" style="font-family: 'JetBrains Mono Semibold';">
                    </div>

                    <h3 class="form-label">Name</h3>
                    <div class="form-inputbox">
                        <input type="text" name="COURIER_NAME" placeholder="Name required" style="font-family: 'JetBrains Mono Semibold';">
                    </div>

                    <h3 class="form-label">HP</h3>
                    <div class="form-inputbox">
                        <input type="text" name="COURIER_HP" placeholder="HP required" style="font-family: 'JetBrains Mono Semibold';">
                    </div>

                    <h3 class="form-label">Email</h3>
                    <div class="form-inputbox">
                        <input type="text" name="COURIER_EMAIL" placeholder="Email required" style="font-family: 'JetBrains Mono Semibold';">
                    </div>

                    <h3 class="form-label">Address</h3>
                    <div class="form-inputbox">
                        <input type="text" name="COURIER_ADDRESS" placeholder="Address required" style="font-family: 'JetBrains Mono Semibold';">
                    </div>

                    <div class="form-inputbox">
                        <input type="submit" value="Add Courier" class="btn">
