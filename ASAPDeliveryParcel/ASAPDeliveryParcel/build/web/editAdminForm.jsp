...
<div class="center-align">
    <h3 class="edit-customer-heading">EDIT ADMIN</h3>
</div>
            ...
            <div class="inner-container">
                <%
                    ...
                    if (id != null) {
                        try {
                            ...
                            ResultSet resultSet = statement.executeQuery("SELECT * FROM APP.ADMIN WHERE ADMIN_ID = '" + id + "'");

                            if (resultSet.next()) {
                                admin_ID = resultSet.getString("ADMIN_ID");
                                manager_Name = resultSet.getString("MANAGER_NAME");
                                manager_Email = resultSet.getString("MANAGER_EMAIL");
                                manager_HP = resultSet.getString("MANAGER_HP");
                                password = resultSet.getString("PASSWORD");

                                System.out.println(admin_ID);
                                System.out.println(manager_Name);
                                System.out.println(manager_Email);
                                System.out.println(manager_HP);
                ...
                <form method="POST" action="AdminServlet">
                    ...
                    <div class="form-inputbox">
                        <input type="text" name="ADMIN_ID" value="<%= id %>" readonly style="font-family: 'JetBrains Mono Semibold';">
                    </div>

                    <h3 class="form-label">Manager Name</h3>
                    <div class="form-inputbox">
                        <input type="text" name="MANAGER_NAME" value="<%= manager_Name %>" placeholder="Manager Name required" style="font-family: 'JetBrains Mono Semibold';">
                    </div>

                    <h3 class="form-label">Manager Email</h3>
                    <div class="form-inputbox">
                        <input type="text" name="MANAGER_EMAIL" value="<%= manager_Email %>" placeholder="Manager Email required" style="font-family: 'JetBrains Mono Semibold';">
                    </div>

                    <h3 class="form-label">Manager Phone Number</h3>
                    <div class="form-inputbox">
                        <input type="text" name="MANAGER_HP" value="<%= manager_HP %>" placeholder="Manager Phone Number required" style="font-family: 'JetBrains Mono Semibold';">
                    </div>

                  <h3 class="form-label">Password</h3>
<div class="form-inputbox">
    <input type="password" name="PASSWORD" value="<%= password %>" placeholder="Password required" style="font-family: 'JetBrains Mono Semibold'; width: 833px;">
</div>
