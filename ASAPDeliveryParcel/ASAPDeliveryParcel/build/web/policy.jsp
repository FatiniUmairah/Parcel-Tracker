<%-- 
    Document   : policy
    Created on : Jan 13, 2024, 1:09:43 AM
...
<body class="sub_page">
  ...
  <section class="about_section layout_padding" style="background-color:#06517B;">
    <div class="container  ">
      <div class="heading_container heading_center">
        ...
        <p>
        This policy establishes guidelines for administrators managing the parcel tracking system to ensure efficient and secure parcel management while maintaining professionalism.
        </p></div>
      <div class="row">
        <div class="col-md-6 ">
          <div class="img-box">
        ...
        <div class="col-md-6">
          <div class="detail-box">
            <h3>
              ...
              <h4>1.1 System Access</h4>
              <p>Administrators must keep access credentials confidential.</p>
              <h4>1.2 Parcel Management</h4>
              <p>Administrators are responsible for timely and accurate parcel status updates.</p>
              <h4>1.3 User Management</h4>
              <p>Administrators adhere to user management protocols and report suspicious activities.</p>
