            ...
            <div class="inner-container">
                ...
                if (id != null) {
                    try {
                        ...
                        ResultSet resultSet = statement.executeQuery("SELECT * FROM APP.CUSTOMER WHERE CUSTOMERID = '" + id + "'");


                        if (resultSet.next()) {
                            name = resultSet.getString("CUSTOMERNAME");
                            hp = resultSet.getString("CUSTOMERHP");
                            email = resultSet.getString("CUSTOMEREMAIL");
                            address = resultSet.getString("CUSTOMERADDRESS");
                            gender = resultSet.getString("CUSTOMERGENDER");
                        }
                ...
                <form method="POST" action="CustomerServlet">
                    ...
                    <div class="form-inputbox">
                        <input type="text" name="CUSTOMERID" value="<%= id %>" readonly style="font-family: 'JetBrains Mono Semibold';">
                    </div>
                    
                    <h3 class="form-label">Name</h3>
                    <div class="form-inputbox">
                        <input type="text" name="CUSTOMERNAME" value="<%= name %>" placeholder="Name required" style="font-family: 'JetBrains Mono Semibold';">
                    </div>

                    <h3 class="form-label">HP</h3>
                    <div class="form-inputbox">
                        <input type="text" name="CUSTOMERHP" value="<%= hp %>" placeholder="HP required" style="font-family: 'JetBrains Mono Semibold';">
                    </div>

                    <h3 class="form-label">Email</h3>
                    <div class="form-inputbox">
                        <input type="text" name="CUSTOMEREMAIL" value="<%= email %>" placeholder="Email required" style="font-family: 'JetBrains Mono Semibold';">
                    </div>

                    <h3 class="form-label">Address</h3>
                    <div class="form-inputbox">
                        <input type="text" name="CUSTOMERADDRESS" value="<%= address %>" placeholder="Address required" style="font-family: 'JetBrains Mono Semibold';">
                    </div>
